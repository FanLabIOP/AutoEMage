...
my $stack_size; my $obj_stigma_x; my $obj_stigma_y; my $dmin; my $dmax;
GetOptions(
	'mode=i' 	=>\$mode,
	'USB_dir=s'	=>\$USB_dir,
	'job=s'	=>\$job_name,
...
#				$num_start = $num_end - 9;
			...
			open (Starfile, ">${ctf_dir}micrograph_${num_name}_ctf.star");
